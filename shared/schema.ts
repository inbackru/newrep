...
export const storyTemplates = pgTable("story_templates", {
  ...
  firstYearPayment: real("first_year_payment"),
  secondYearRate: real("second_year_rate"),
  secondYearPayment: real("second_year_payment"),
...
export const propertyFormSchema = z.object({
  ...
  mortgageType: z.enum(["basic", "family", "it", "tranche"]).default("basic"),
  // Additional fields for tranche mortgage
  firstYearPayment: z.number().min(0, "Платёж первого года должен быть больше 0").optional(),
  secondYearRate: z.number().min(0.01, "Ставка с 2 года должна быть больше 0").optional(),
  secondYearPayment: z.number().min(0.01, "Платёж с 2 года должен быть больше 0").optional(),
